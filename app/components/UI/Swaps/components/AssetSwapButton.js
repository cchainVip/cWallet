...
function AssetSwapButton({ isFeatureLive, isNetworkAllowed, isAssetAllowed, onPress, onPressSwap, onPressCross }) {
		...
		<>
			<View style={isDisabled && styles.disabledButton}>
				<AssetActionButton
					...
					onPress={isDisabled ? '' : onPressSwap}
				/>
			</View>
			<View style={isDisabled && styles.disabledButton}>
				<AssetActionButton
					...
					onPress={isDisabled ? '' : onPressCross}
				/>
			</View>
			<InfoModal
