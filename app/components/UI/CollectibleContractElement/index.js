...
function CollectibleContractElement({
	...
	// zyl NFT
	if (chainId === '51112') {
		asset.logo = "https://d2h8jcrpwh6m7t.cloudfront.net/tokens/nfts/" + asset.address.toLowerCase() + "/logo.png";
	} else {
		asset.logo = "https://d2h8jcrpwh6m7t.cloudfront.net/tokens/" + chainId + "/nfts/" + asset.address.toLowerCase() + "/logo.png";
	}
