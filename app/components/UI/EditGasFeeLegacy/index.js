...
const GAS_PRICE_MIN = new BigNumber(1); // zyl gas price 最低值
						...
						<View>
							<View style={styles.customGasHeader}>
								<TouchableOpacity onPress={onCancel}>
									<Icon name={'ios-arrow-back'} size={24} color={colors.blue} />
								</TouchableOpacity>
								<Text bold blue>
									...
									<View style={styles.advancedOptionsInputsContainer}>
										...
										<View style={styles.rangeInputContainer}>
											<RangeInput
												...
												// zyl 转账时编辑gas费，默认不显示的修正
												value={(gasFee && gasFee.suggestedGasPrice)?(gasFee.suggestedGasPrice + ""):'1'}
