...
const styles = StyleSheet.create({
	...
	urlInput: { // zyl
		...fontStyles.normal,
		backgroundColor: Device.isAndroid() ? colors.black : colors.grey000,
		borderRadius: 30,
	...
	render = () => {
		...
		return (
			<TouchableOpacity onPress={this.onTitlePress} style={styles.wrapper}>
				{(true || !isHomePage) && (<View style={styles.currentUrlWrapper}>
				...
				{false && isHomePage && (<Text onPress={this.onTitlePress} style={styles.urlInput}>
