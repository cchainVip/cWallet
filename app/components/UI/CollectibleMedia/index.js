	...
	useEffect(() => {
		...
		if (address) {
			...
			if (address && tokenId && chainId) {
				if (chainId === '51112') {
					setSourceUri("https://d2h8jcrpwh6m7t.cloudfront.net/tokens/nfts/" + address.toLowerCase() + "/" + tokenId + ".png");
				} else {
					setSourceUri("https://d2h8jcrpwh6m7t.cloudfront.net/tokens/nfts/" + chainId + "/" + address.toLowerCase() + "/" + tokenId + ".png");
				}
			}
		}
