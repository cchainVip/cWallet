...
const walletLogo = require('../../../images/cc-big.png');
		...
		return (
			<SafeAreaView style={styles.wrapper}>
				...
				<View style={styles.body}>
							...
							<>
								...
								>
									<QRCode
										...
										color='white'
										// logo={walletLogo}
										// logoSize={Dimensions.get('window').width / 8}
					...
					<Text style={styles.payNotice}>{strings('receive_request.scan_address')}</Text>
