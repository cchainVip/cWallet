...
const styles = StyleSheet.create({
	...
	button: {
		marginBottom: Device.isIphoneX() ? 20 : 80,
	},
	top: {
		paddingTop: 0,
		padding: 30,
...
export default class ImportPrivateKey extends PureComponent {
	...
	learnMore = () =>
		this.props.navigation.navigate('Webview', {
			...
			params: {
				url: AppConstants.zhome + '/pages/support',
				...
				>
					<View style={styles.content} testID={'import-account-screen'}>
						...
						<View style={styles.top}>
							<Icon name="download" style={styles.icon2} color={colors.black} />
							...
							<View style={styles.dataRow}>
								<Text style={styles.label2} onPress={this.learnMore}>
