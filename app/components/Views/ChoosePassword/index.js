...
class ChoosePassword extends PureComponent {
					...
					<>
						...
						<View>
							<Switch
								...
								trackColor={Device.isIos() ? { true: colors.green300, false: colors.grey300 } : { true: colors.black, false: colors.fontSecondary }}
	...
	learnMore = () => {
		this.props.navigation.push('Webview', {
			...
			params: {
				url: AppConstants.zhome + '/pages/reset',
				title: AppConstants.zhome.split('://')[1],
			},
		});
	};
