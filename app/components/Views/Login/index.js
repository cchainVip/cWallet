...
class Login extends PureComponent {
	...
	onLogin = async () => {
			...
			// const mnemonic = await KeyringController.exportSeedPhrase(this.state.password);
			// const encryptionLib = await AsyncStorage.setItem(ENCRYPTION_LIB, "gallery napkin cube churn vehicle bean mesh square seek tourist child that");
