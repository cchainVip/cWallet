...
const Wallet = ({ navigation }: any) => {
	...
	const renderTabBar = useCallback(
		() => (
			<DefaultTabBar // zyl 下划线
				underlineStyle={styles.tabUnderlineStyle}
				activeTextColor={colors.blue}
				inactiveTextColor={colors.fontPrimary}
				backgroundColor={colors.white}
	...
	return (
		<TabNavigator tabBarStyle={styles.tabBarStyle}>
		  ...
		  <TabNavigator.Item
			...
			titleStyle={styles.tabText}
			renderIcon={() => <Image style={styles.tabIcon} source={findActiveIcon} />}
			renderSelectedIcon={() => <Image style={styles.tabIconSel} source={findIcon} />}
		  ...
		  <TabNavigator.Item
			...
			titleStyle={styles.tabText}
			renderIcon={() => <Image style={styles.tabIcon} source={myActiveIcon} />}
			renderSelectedIcon={() => <Image style={styles.tabIconSel} source={myIcon} />}
			onPress={() => showMy()}>
			<View />
		  </TabNavigator.Item>
		</TabNavigator>
