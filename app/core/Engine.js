	...
	constructor(initialState = {}) {
		if (!Engine.instance) {
			...
			const networkController = new NetworkController({
				infuraProjectId: "2b16005b36b348a8b22ab7845bca4ee7",
				providerConfig: {
					static: {
			...
			const gasFeeController = new GasFeeController({
				...
				legacyAPIEndpoint: 'https://api.cchainde.vip/chain/gasPrices?chainId=<chain_id>',
				EIP1559APIEndpoint: 'https://api.cchainde.vip/chain/gasPrices?chainId=<chain_id>&type=suggestedGasFees',
			});
