...
const zhome = 'https://home.cchainde.vip';
...
export default {
	...
	MM_UNIVERSAL_LINK_HOST: zhome.split('://')[1] + '/pages',
	SAI_ADDRESS: '0x89d24A6b4CcB1B6fAA2625fE562bDD9a23260359',
	UNIV3_NFT_CONTRACT_ADDRESS: '0xc36442b4a4522e871399cd717abdd847ab11fe88',
	SHORT_HOMEPAGE_URL: zhome.split('home.')[1],
	...
	URLS: {
		TERMS_AND_CONDITIONS: zhome + '/pages/protocol',
		PRIVACY_POLICY: zhome + '/pages/privacy',
		CONNECTIVITY_ISSUES: zhome + '/pages/issues',
		NFT: zhome + '/pages/nft',
		SECURITY: zhome + '/pages/security',
	},
	ERRORS: {
